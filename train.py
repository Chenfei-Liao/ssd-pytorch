...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = 'model_data/g_ghost_regnet_8.0g_79.0.pth'
    #-----------------------------------------------------#
    #   input_shape     输入的shape大小ogs/last_epoch_weights.pth
    #------------------------------------------------------#
    input_shape     = [300, 300]
    #------------------------------------------------------#
    #   vgg或者mobilenetv2
    #------------------------------------------------------#
    backbone        = "gghostnet080" # "mobilenetv3large"
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    input_names = ['input']
    output_names = ['output']
    torch.onnx.export(model, x, f'onnxfiles/{backbone}.onnx', input_names=input_names, output_names=output_names, verbose='True', opset_version=11)
